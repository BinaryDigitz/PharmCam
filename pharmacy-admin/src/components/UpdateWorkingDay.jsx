...
function UpdateWorkingDay({ setShowWorkingdayForm }) {
  ...
  return (
    <div className="grid place-content-center h-full text-white">
      <div className="border p-4 rounded min-w-sm max-w-lg relative bg-gray-100 text-black">
        <button
          onClick={() => setShowWorkingdayForm(false)}
        ...
        <form onSubmit={handleSubmit} className="mt-8">
          ...
          <div className="flex gap-4 my-4">
            <div className="w-1/2">
              <label htmlFor="openingTime" className="block">
                Opening
              </label>
              <input
                type="time"
            ...
            <div className="w-1/2 ">
              <label htmlFor="closingTime" className="block">
                Closing
              </label>
              <input
                required
                ...
                type="time"
                className=" border w-full rounded  border-gray-400 py-3 px-2 mt-1"
              />
            </div>
          </div>
          <button
